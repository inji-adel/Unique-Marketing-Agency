    ...
    <div class="how-section1">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>We are flexible and dynamic with our clients and we offer them tailored solutions in all our ongoing projects We always seek to exceed our clients’ expectations.</p>

                <h3>Insights</h3>
                <p>With a mindset that customer drives the center stage of any business establishment, we bring an inner insight to you about your customers because we understand the criticality of business success in this digital age.</p>
            <h3>Creativity that works</h3>
            <p>Working in an environment where challenges are faced at every step, we bring diversity in an unconventional way to the problems our clients face by providing them out of the box solutions with the most relevant and optimum approach.</p>

            <h3>We work hard</h3>
            <p>There’s no substitute for hard work and we do everything in our power to ensure our clients have what they need, when they need it with an exceptional quality, hard to be found anywhere. </p>
                ...
                <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                                ...
                                <div class="row">
                                    <div class="col-lg-10">
                                        <p> “Your goals are our goals and we will stop at nothing to align and reach them”.  </p>
                                    </div>
                                </div>
